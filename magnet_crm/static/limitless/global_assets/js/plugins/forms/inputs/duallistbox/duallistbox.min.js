...
! function(a, b, c, d) {
    ...
    var v = "bootstrapDualListbox",
        w = {
            ...
            infoTextFiltered: '<span class="badge badge-success">Filtered</span> {0} from {1}',
    ...
    e.prototype = {
        init: function() {
            this.container = a('<div class="bootstrap-duallistbox-container"> <div class="box1"> <label></label> <input class="filter" type="text"> <div class="btn-group buttons"> <button type="button" class="btn  " id="moveall_btn"> <i class="fa fa-arrow-right"></i> <i></i> </button> <button type="button" class="btn move"> <i></i> </button> </div> <select multiple="multiple" onchange="'+this.element[0].id+'_left(this)"></select> <span class="info-container"> <span class="info"></span> <button type="button" class="btn clear1 float-right"></button> </span> </div> <div class="box2"> <label></label> <input class="filter" type="text"> <div class="btn-group buttons"> <button type="button" class="btn remove " > <i></i> </button> <button type="button" class="btn " id="removeall_btn"> <i class="fa fa-arrow-left"></i> <i></i> </button> </div> <select multiple="multiple" onchange="'+this.element[0].id+'_right(this)"></select> <span class="info-container"> <span class="info"></span> <button type="button" class="btn clear2 float-right"></button> </span> </div></div>').insertBefore(this.element), this.elements = {
