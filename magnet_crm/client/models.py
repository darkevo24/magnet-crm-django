...
class Client(Base_Model):
	...
	medium = models.CharField(max_length=255, default='',null=True, blank=True)
	campaign = models.CharField(max_length=255, default='',null=True, blank=True)
	term = models.CharField(max_length=255, default='',null=True, blank=True)
	content = models.CharField(max_length=255, default='',null=True, blank=True)
